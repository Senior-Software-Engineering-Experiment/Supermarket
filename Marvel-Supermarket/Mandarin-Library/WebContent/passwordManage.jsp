...
<body>
	<div role="tabpanel" class="tab-pane" id="chan">
		<div class="check-div">Initial Password: 00010001</div>
		<div
			style="padding: 50px 0; margin-top: 50px; background-color: #fff; text-align: right; width: 420px; margin: 50px auto;">
			<form class="form-horizontal">
				<div class="form-group">
					<label for="sKnot" class="col-xs-4 control-label">Origin Password：</label>
					<div class="col-xs-5">
				...
				<div class="form-group">
					<label for="sKnot" class="col-xs-4 control-label">Confirm Password：</label>
					<div class="col-xs-5">
						<input type="" class="form-control input-sm duiqi" id="sKnot"
							placeholder="" style="margin-top: 7px;">
					</div>
