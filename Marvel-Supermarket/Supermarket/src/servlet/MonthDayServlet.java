 ...
 */
@WebServlet("/MonthDayServlet")
public class MonthDayServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private IncomeDAO incomedao = IncomeDAO.getInstance();
	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public MonthDayServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Incomegroup> incomegroup=IncomeDAO.getMonthdayIncome(year, month);
