...
/**
 * Servlet implementation class EditNoticesServlet
 */
@WebServlet("/EditNoticesServlet")
public class EditNoticesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private PostDAO postDAO = PostDAO.getInstance();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditNoticesServlet() {
        super();
