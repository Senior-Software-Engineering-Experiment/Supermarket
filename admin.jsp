	...
	color: #666;
		...
		<div class="leftMeun" id="leftMeun">
			...
			<div id="personInfor">
				...
				<p>&nbsp;</p>
				<div class="meun-item" href="#money" aria-controls="money" role="tab"
					data-toggle="tab">
			...
			<div class="tab-content">
				...
				<div role="tabpanel" class="tab-pane" id="user">
					<div class="check-div form-inline">
						<div class="col-xs-3" style="padding-left: 2px">
							<button class="btn btn-yellow btn-xs" id="add"
								data-toggle="modal" data-target="#addUser">添加售货员</button>
						</div>
						<div class="col-xs-41">
							<select id="type">
								...
								id="searchBlank" placeholder="输入相应内容搜索"
								style="color: gray">
							<form action="LogoutServlet" name="tuichuForm"></form>
					...
					<div class="data-div">
						<div class="row tableHeader">
							<div class="col-xs-222 ">用户名</div>
							<div class="col-xs-223">姓名</div>
							<div class="col-xs-224">性别</div>
							<div class="col-xs-222">电话号码</div>
							<div class="col-xs-225">邮箱</div>
							<div class="col-xs-222">操作</div>
						</div>
									...
									<div class="container-fluid">
										...
										<form class="form-horizontal" onsubmit="return checkForm()">
											...
											<div class="form-group">
												...
												<div class="col-xs-8 ">
													<input class="form-control input-sm duiqi" id="Name"
														...
														oninput="checkName()" placeholder="请输入姓名..."
											...
											<div class="form-group">
												...
												<div class="col-xs-8">
													<input class="form-control input-sm duiqi" type="text"
														...
														oninput="checkEmail()" placeholder="请输入邮箱..."
											...
											<div class="modal-footer">
												...
												<input type="submit" onclick="addManager()" value="完成"
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="gridSystemModalLabel">编辑售货员账号</h4>
								</div>
								<div class="modal-body">
									<div class="container-fluid">
                             ...
                             -->
								...
								<div class="modal-footer">
									<button id="closeEdit" type="button"
										class="btn btn-xs btn-white" data-dismiss="modal">取消</button>
						...
						<form class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-xs-5">
									<input id="oldPassword" type="password" name="oPass"
										...
										id="div1" class="tian" style="margin-top: -25px">*必填</span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-5">
									<input id="newPassword1" type="password" name="Password"
										...
										id="div2" class="tian" style="margin-top: -25px">*必填</span>
								</div>
							</div>

							<div class="form-group">
								<label for="sKnot" class="col-xs-4 control-label">重输新密码：</label>
								<div class="col-xs-5">
							...
							<div class="form-group text-right">
								<div class="col-xs-offset-4 col-xs-5"
									...
									<button type="button" class="btn btn-xs btn-white"
										onclick="delete1()" style="margin-right: 20px !important">取消</button>

									<button type="button" class="btn btn-xs btn-green"
										onclick="changeP()">完成</button>
								</div>
							</div>
						</form>
					</div>
				...
				<div role="tabpanel" class="tab-pane" id="post">
					<div class="check-div form-inline">
						...
						<div class="col-xs-41">
							 <select
								class=" form-control" name="sort" id="postsort" style="display:none">
								<option>PostNo</option>
								<option>Post Time First</option>
								<option>Recently Post First</option>
							</select>
							<input type="text" class="form-control input-sm"
								id="postcontent" placeholder="输入序号进行搜索"
								style="color: gray">

							<input type="image" src="images/搜索.png"  
								style="width: 30px !important; float: right; margin-top: -45px !important; margin-left: 210px !important"
								onclick="postsearch()" />
					...
					<div class="data-div">
						<div class="row tableHeader">
							...
							<div class="col-xs-233 ">序号</div>
							<div class="col-xs-234 ">公告名称</div>
							<div class="col-xs-234 ">时间</div>
							<div class="col-xs-234 ">内容</div>
							<div class="col-xs-234 " style="text-align: center;">操作</div>
						</div>
						<div class="tablebody" id="postbody"></div>
							<div class="row">
								<!--这里的数字可以实现宽度的变化，与上面相对应-->
								<div class="col-xs-233 "></div>
								<div class="col-xs-234 "></div>
								<div class="col-xs-234 "></div>
								<div class="col-xs-234">
									</div>
			...
			$
					.ajax({
						...
						success : function(data) {
							...
							wel
									.append("欢迎您， ${sessionScope.userName} 经理!");
        					...
        					+i+'"><div class="col-xs-2 " id="dlUserName">'
										...
										+ i
										+ '" onclick="wdnmd(this.id)">编辑</button><button class="btn btn-danger btn-xs" id="de'
										+ i
										+ '" onclick="deleteL(\''
										+ username
										+ '\',this.id)">删除</button></div></div>';
								list.append(div);
					...
					.ajax({
						...
						success : function(json) {
							...
							for (var i = 0; i < json.length; i++) {
								...
								ht = ht + "<div class='row'>";
								ht = ht
										+ "<div class='col-xs-233 ' style='height: 50px; overflow:hidden;text-align:left'>"
										+ json[i].postno + "</div>";
								ht = ht
										+ "<div class='col-xs-234 ' style='height: 50px; overflow:hidden;text-align:left'>"
										+ json[i].title + "</div>";
								ht = ht
										+ "<div class='col-xs-234 ' style='height: 50px; overflow:hidden;text-align:left'>"
										+ json[i].posttime + "</div>";
								ht = ht
										...
										+ json[i].content + "</div>";
								ht = ht
										+ "<div class='col-xs-234 '><button class='btn btn-success btn-xs' data-toggle='modal' data-target='#changeNotice' onclick='toEditPost( "
										+ json[i].postno
										+ " ) '>编辑</button><button onclick='toDeletePost( "
										+ json[i].postno
										+ " )' class='btn btn-danger btn-xs' data-toggle='modal' data-target='#deleteNotice'>删除</button></div>";
								ht = ht + "</div>";
							}
							$("#postbody").html(ht);
